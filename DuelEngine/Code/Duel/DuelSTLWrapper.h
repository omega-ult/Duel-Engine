//  [12/18/2012 OMEGA] created

#ifndef _DUELSTLWRAPPER_H_
#define _DUELSTLWRAPPER_H_
...
namespace Duel
{
	...
	*/
	...
	/** 
	* 
	* \brief Prepiared IteratorWrapper for container like std::list
	*
	* 
	...
	*/
	...
	class ListIteratorWrapper : public IteratorWrapper<T, IteratorType, typename  T::value_type>
	{
	...
	public:
		...
		*/
		ListIteratorWrapper ( IteratorType start, IteratorType last )
	...
	*/
	template <typename T>
	class ListIterator : public ListIteratorWrapper<T,  typename T::iterator>{
	public:
		/** Constructor.
		@remarks
		Provide a start and end iterator to initialise.
		*/	
		ListIterator( typename T::iterator start, typename T::iterator last )
			: ListIteratorWrapper<T,  typename T::iterator>(start , last )
		{
		}
		...
		*/
		explicit ListIterator( T& c )
			: ListIteratorWrapper<T,  typename T::iterator> ( c.begin(), c.end() )
		{
		}
	...
	*/
	template <typename T>
	class ConstListIterator : public ListIteratorWrapper<T,  typename T::const_iterator>{
	public:
		/** Constructor.
		@remarks
		Provide a start and end iterator to initialise.
		*/	
		ConstListIterator( typename T::const_iterator start, typename T::const_iterator last )
